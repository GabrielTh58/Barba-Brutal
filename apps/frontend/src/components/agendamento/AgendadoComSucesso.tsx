...
export default function AgendadoComSucesso() {
    return (
        <div className="flex flex-col items-center">
            ...
            <h2 className="text-2xl md:text-3xl text-center py-4 font-black">Iradoooo! Tudo marcado!</h2>
            <h3 className="text-zinc-400 text-lg font-thin max-w-96 text-center">
